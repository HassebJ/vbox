...
module.exports = function(options){
	...
	if(isset(options.app.onAll)){
		var originalCallback = options.callback;
		options.callback = function(locals){
			options.response.head = locals;
			options.app.onAll(options.request, options.response, options.mysql, function(){
				originalCallback(locals);
			});
		}
	}
	...
	// LOGGED IN && mysql set
	if(isset(cookies[locals.userCookie]) && options.mysql && options.mysql[locals.getUserFrom]){
